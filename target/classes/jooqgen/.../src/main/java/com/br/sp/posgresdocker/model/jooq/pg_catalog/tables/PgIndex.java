...
import com.br.sp.posgresdocker.model.jooq.pg_catalog.tables.records.PgIndexRecord;
...
public class PgIndex extends TableImpl<PgIndexRecord> {
    ...
    private static final long serialVersionUID = -338495147;
     ...
     */
    public final TableField<PgIndexRecord, Object[]> INDKEY = createField("indkey", .getArrayDataType(), this, "");
    ...
    public final TableField<PgIndexRecord, Object> INDEXPRS = createField("indexprs", , this, "");

    /**
     * @deprecated Unknown data type. Please define an explicit {@link org.jooq.Binding} to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.
     */
    @java.lang.Deprecated
    public final TableField<PgIndexRecord, Object> INDPRED = createField("indpred", , this, "");
