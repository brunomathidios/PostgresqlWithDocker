...
public class Max13 extends AbstractRoutine<LocalDateTime> {

    private static final long serialVersionUID = -1439895365;
     ...
     */
    public Max13() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.LOCALDATETIME);
