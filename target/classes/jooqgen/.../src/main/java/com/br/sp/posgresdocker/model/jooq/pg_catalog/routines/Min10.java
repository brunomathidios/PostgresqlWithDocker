...
public class Min10 extends AbstractRoutine<LocalTime> {

    private static final long serialVersionUID = -1599824339;
     ...
     */
    public Min10() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.LOCALTIME);
