...
public class Min9 extends AbstractRoutine<LocalDate> {

    private static final long serialVersionUID = -1097593770;
     ...
     */
    public Min9() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.LOCALDATE);
